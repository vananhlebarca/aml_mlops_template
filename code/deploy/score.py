...
@input_schema('data', NumpyParameterType(np.array([[7.4, 0.70, 0.00, 1.9, 0.076, 11.0, 34.0, 0.9978, 3.51, 0.56, 9.4, 5]])))
@output_schema(StandardPythonParameterType({'predict': [['red-white']]}))
def run(data):
